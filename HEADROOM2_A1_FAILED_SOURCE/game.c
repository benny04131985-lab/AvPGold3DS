...
void UpdateGame(void)
{
	...
	#ifdef __3DS__
	{
	    ...
	    AvP3DS_HeadroomAccumulate(1, avp3ds_hr_start);
	}
#else
	PlayerPheromoneSystem();
#endif
	#ifdef __3DS__
	{
	    unsigned long long avp3ds_hr_start = AvP3DS_HeadroomTick();
	    AiPheromoneSystem();
	    AvP3DS_HeadroomAccumulate(2, avp3ds_hr_start);
	}
#else
	AiPheromoneSystem();
#endif
	...
	#ifdef __3DS__
	{
	    unsigned long long avp3ds_hr_start = AvP3DS_HeadroomTick();
	    DoHive();
	    AvP3DS_HeadroomAccumulate(3, avp3ds_hr_start);
	}
#else
	DoHive();
#endif
	#ifdef __3DS__
	{
	    unsigned long long avp3ds_hr_start = AvP3DS_HeadroomTick();
	    DoSquad();
	    AvP3DS_HeadroomAccumulate(4, avp3ds_hr_start);
	}
#else
	DoSquad();
#endif
	...
	ProfileStart();
 	...
 	#ifdef __3DS__
 	{
 	    unsigned long long avp3ds_hr_start = AvP3DS_HeadroomTick();
 	    ObjectBehaviours();
 	    AvP3DS_HeadroomAccumulate(5, avp3ds_hr_start);
 	}
#else
 	ObjectBehaviours();
#endif
	...
	#ifdef __3DS__
	{
	    unsigned long long avp3ds_hr_start = AvP3DS_HeadroomTick();
	    MaintainPlayer();
	    AvP3DS_HeadroomAccumulate(6, avp3ds_hr_start);
	}
#else
	MaintainPlayer();
#endif
	...
	if(AvP.Network != I_No_Network)	#ifdef __3DS__
	{
	    unsigned long long avp3ds_hr_start = AvP3DS_HeadroomTick();
	    NetCollectMessages();
	    AvP3DS_HeadroomAccumulate(8, avp3ds_hr_start);
	}
#else
	NetCollectMessages();
#endif
	...
	#ifdef __3DS__
	{
	    unsigned long long avp3ds_hr_start = AvP3DS_HeadroomTick();
	    ObjectDynamics();
	    AvP3DS_HeadroomAccumulate(7, avp3ds_hr_start);
	}
#else
	ObjectDynamics();
#endif
	...
	if(AvP.Network != I_No_Network)	#ifdef __3DS__
	{
	    unsigned long long avp3ds_hr_start = AvP3DS_HeadroomTick();
	    NetSendMessages();
	    AvP3DS_HeadroomAccumulate(9, avp3ds_hr_start);
	}
#else
	NetSendMessages();
#endif
	...
	if(playerPherModule)
	{
		#ifdef __3DS__
		{
		    ...
		    AvP3DS_HeadroomAccumulate(10, avp3ds_hr_start);
		}
#else
		PlatSetEnviroment(playerPherModule->m_sound_env_index,playerPherModule->m_sound_reverb);
#endif		
	...
	#ifdef __3DS__
	{
	    unsigned long long avp3ds_hr_start = AvP3DS_HeadroomTick();
	    SoundSys_Management();
	    AvP3DS_HeadroomAccumulate(11, avp3ds_hr_start);
	}
#else
	SoundSys_Management();
#endif
	#ifdef __3DS__
	{
	    unsigned long long avp3ds_hr_start = AvP3DS_HeadroomTick();
	    DoPlayerSounds();
	    AvP3DS_HeadroomAccumulate(12, avp3ds_hr_start);
	}
#else
	DoPlayerSounds();
#endif
