...
MARKER = "ALIEN-HUD1A-LOWER-HEALTH"
...
def main() -> int:
    ...
    try:
        ...
        main_c = replace_once(
            ...
            "             !alienHUDCaptured &&\n"
            "             avp3ds_marine_hud_texture_initialized)\n",
            "Alien-safe backdrop geometry routing",
        )

        # The same species exclusion is needed in the texture-bind branch.
        main_c = replace_once(
            main_c,
            "    else if (!predatorHUDCaptured &&\n"
            "             avp3ds_marine_hud_texture_initialized)\n",
            ...
            "             !alienHUDCaptured &&\n"
            "             avp3ds_marine_hud_texture_initialized)\n",
            "Alien-safe texture bind routing",
        )
    ...
    hud_backup = hud_path.with_name("hud.c.pre-ALIEN-HUD1A.bak")
    main_backup = main_path.with_name("main_3ds.c.pre-ALIEN-HUD1A.bak")
    ...
    print("ALIEN-HUD1A installed successfully.")
