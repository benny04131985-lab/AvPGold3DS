...
MARKER = "ALIEN-HUD1B-LOWER-MESSAGES"
...
def main() -> int:
    ...
    hud_backup = hud_path.with_name("hud.c.pre-ALIEN-HUD1B.bak")
    main_backup = main_path.with_name("main_3ds.c.pre-ALIEN-HUD1B.bak")
    ...
    print("ALIEN-HUD1B installed successfully.")
