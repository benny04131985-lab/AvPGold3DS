...
void ExecuteFreeMovement(STRATEGYBLOCK* sbPtr)
{
	...
	/* KJL 16:59:53 01/07/97 - New 3d strategy code	*/
	{
		 ...
		 * 3DS player translational locomotion = 65% of retail/current speed.
		 * Preserve species ratios, run/walk behavior, turning and jump speed.
		 */
		forwardSpeed = (forwardSpeed * 13) / 20;
		strafeSpeed = (strafeSpeed * 13) / 20;
#endif
