...
extern void AvP3DS_BeginHUDCapture(int group);
extern void AvP3DS_EndHUDCapture(void);
...
#ifdef __3DS__
	/*
	 * AVP-HUD1A: this frame reached the genuine gameplay HUD path.
	 */
	/* PRED-HUD1E3-SWAP-AND-DEATH-BLACK: dead non-observer frames stay black. */
...
//	GlobalAmbience=16384;
	...
	{	   
		...
		switch(AvP.PlayerType)						
		{
			case I_Marine:
			{
				...
				#ifdef __3DS__
				AvP3DS_BeginFlatStereoOverlay();
				#endif
				DrawMarineSights();
				#ifdef __3DS__
				AvP3DS_EndFlatStereoOverlay();
				#endif
	       	...
	       	case I_Predator:
			{
				...
				//DrawPredatorEnergyBar();						
	  			//DisplayHealthAndArmour();
			   	/* PRED-HUD1A-SPECIES-ISOLATED: Predator wrist only. */
			   	#ifdef __3DS__
			   	AvP3DS_BeginHUDCapture(
			   	    AVP3DS_HUD_GROUP_PRED_WRIST);
			   	#endif
				...
				if((playerStatusPtr->invulnerabilityTimer/12000 %2)==0)
				{
	  				/* PRED-HUD1A-SPECIES-ISOLATED: Predator status only. */
	  				#ifdef __3DS__
	  				AvP3DS_BeginHUDCapture(
	  				    AVP3DS_HUD_GROUP_PRED_STATUS);
	  				#endif
	  				...
	  				/* PRED-HUD1F3-SPEAR-AMMO-PINNED: spear-gun ammo only. */
	  				#ifdef __3DS__
	  				AvP3DS_BeginHUDCapture(
			...
			case I_Alien:
			{
				...
				if((playerStatusPtr->invulnerabilityTimer/12000 %2)==0)
				{
					/* ALIEN-HUD1A2-LOWER-HEALTH: Alien health only. */
					#ifdef __3DS__
					AvP3DS_BeginHUDCapture(
...

	{
		...
		HeadUpDisplayZOffset = 0;
		...
		#if 1||!PREDATOR_DEMO
#ifdef __3DS__
            /* PRED-HUD1B2-SPECIES-ISOLATED: dedicated species message groups. */
            ...
            /* ALIEN-HUD1B2-LOWER-MESSAGES: Alien message ticker. */
...
static bool avp3ds_predator_hud_frame = false;
...
/*
 * PRED-HUD1F3-SPEAR-AMMO-PINNED: spear-gun ammo is captured independently so it cannot
